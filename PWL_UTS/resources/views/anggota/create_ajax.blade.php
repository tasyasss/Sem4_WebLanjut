        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="" type="text" name="anggota_nomor" id="anggota_nomor" class="form-control"
                        required>
                    <small id="error-anggota_nomor" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Nama Anggota</label>
                    <input value="" type="text" name="anggota_nama" id="anggota_nama" class="form-control"
                        required>
