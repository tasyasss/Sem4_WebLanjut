...
@else
    <form action="{{ url('/buku/' . $buku->buku_id . '/update_ajax') }}" method="POST" id="form-edit">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="kategori_id" id="kategori_id" class="form-control" required>
                            ...
                            @foreach ($kategori as $k)
                                <option {{ $k->kategori_id == $buku->kategori_id ? 'selected' : '' }} value="{{ $k->kategori_id }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="rak_id" id="rak_id" class="form-control" required>
                            ...
                            @foreach ($rak as $r)
                                <option {{ $r->rak_id == $buku->rak_id ? 'selected' : '' }} value="{{ $r->rak_id }}">
                                    {{ $r->rak_nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $buku->buku_kode }}" type="text" name="buku_kode" id="buku_kode"
                    ...
                    <div class="form-group">
                        <label>Penulis</label>
                        <input value="{{ $buku->buku_penulis }}" type="text" name="buku_penulis" id="buku_penulis"
                        class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $buku->buku_penerbit }}" type="text" name="buku_penerbit" id="buku_penerbit"
                        class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $buku->tahun_terbit }}" type="number" name="tahun_terbit" id="tahun_terbit"
                            class="form-control" required>
